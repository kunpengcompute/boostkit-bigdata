 ...
 * org/apache/calcite/util/graph/Pair.java
 * Pair of objects.
 *
...
public class Pair<T1, T2>
     ...
     */
    public static <L, R> Iterable<L> getLeft(
     ...
     */
    public static <L, R> Iterable<R> getRight(
            final Iterable<? extends Map.Entry<L, R>> iterable) {
    ...
    public static <K, V> List<K> getLeft(
    ...
    public static <K, V> List<V> getRight(
            final List<? extends Map.Entry<K, V>> pairs) {
