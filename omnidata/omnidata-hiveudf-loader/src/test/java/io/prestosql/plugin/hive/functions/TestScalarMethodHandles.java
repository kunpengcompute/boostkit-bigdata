...
import static io.prestosql.plugin.hive.functions.type.TestObjectEncoders.THREE_LONG_VAL;
...
public class TestScalarMethodHandles
{
    ...
    private static final double DOUBLE_VAL = 2.1;
            ...
            throws Throwable
    {
        ...
        runCase("bigint", tokens("bigint,bigint"), THREE_LONG_VAL, 2L, 1L);
        runCase("varchar", tokens("varchar,double"), Slices.utf8Slice("output"),
                Slices.utf8Slice("input"), DOUBLE_VAL);
        runCase("array(bigint)", tokens("bigint,bigint"),
                createArrayBlock(), 2L, 1L);
    }

    private void runCase(final String resultType, final String[] argumentTypes,
                         final Object result, final Object... arguments)
            throws Throwable
    {
        ...
        TestingScalarFunctionInvoker invoker =
                new TestingScalarFunctionInvoker(signature, result);
        final Object output;
        if (arguments.length == 1) {
            ...
            output = methodHandle.invoke(
                    invoker, arguments[0], arguments[1], arguments[2]);
        }
        else if (arguments.length == 4) {
            output = methodHandle.invoke(
                    invoker, arguments[0], arguments[1],
    ...
    private Signature createScalarSignature(final String returnType,
                                            final String... argumentTypes)
    {
        return new Signature(QualifiedObjectName.valueOf(
                "hive.default.testing_" + number.incrementAndGet()),
                FunctionKind.SCALAR,
    ...
    private Block createArrayBlock()
    {
        ...
        return ArrayBlock.fromElementBlock(1,
                Optional.empty(), IntStream.range(0, 2).toArray(),
                emptyValueBlock);
    }
            ...
            implements ScalarFunctionInvoker
    {
        ...
        TestingScalarFunctionInvoker(final Signature signature,
                                     final Object result)
        {
        ...
        @Override
        public Object evaluate(final Object... inputs)
        {
            this.inputs = inputs;
            return result;
        }
