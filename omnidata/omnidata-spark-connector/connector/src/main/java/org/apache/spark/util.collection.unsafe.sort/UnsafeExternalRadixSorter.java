 ...
 */
public final class UnsafeExternalRadixSorter extends MemoryConsumer {

  private static final Logger logger = LoggerFactory.getLogger(UnsafeExternalRadixSorter.class);

  @Nullable
  private final List<PrefixComparator> prefixComparators;
   ...
   * {@link UnsafeExternalRadixSorter}, because {@link UnsafeExternalRadixSorter} is referenced by
  ...
  @Nullable private volatile UnsafeInMemoryRadixSorter inMemSorter;
  ...
  public static UnsafeExternalRadixSorter createWithExistingInMemorySorter(
      TaskMemoryManager taskMemoryManager,
      BlockManager blockManager,
      SerializerManager serializerManager,
      TaskContext taskContext,
      Supplier<RecordComparator> recordComparatorSupplier,
      List<PrefixComparator> prefixComparators,
      int initialSize,
      long pageSizeBytes,
      int numElementsForSpillThreshold,
      UnsafeInMemoryRadixSorter inMemorySorter,
      long existingMemoryConsumption) throws IOException {
    UnsafeExternalRadixSorter sorter = new UnsafeExternalRadixSorter(taskMemoryManager, blockManager,
      serializerManager, taskContext, recordComparatorSupplier, prefixComparators, initialSize,
  ...
  public static UnsafeExternalRadixSorter create(
      TaskMemoryManager taskMemoryManager,
      BlockManager blockManager,
      SerializerManager serializerManager,
      TaskContext taskContext,
    ...
    return new UnsafeExternalRadixSorter(taskMemoryManager, blockManager, serializerManager,
      taskContext, recordComparatorSupplier, prefixComparators, initialSize, pageSizeBytes,
      numElementsForSpillThreshold, null, canUseRadixSort);
  }

  private UnsafeExternalRadixSorter(
      TaskMemoryManager taskMemoryManager,
      BlockManager blockManager,
      SerializerManager serializerManager,
      TaskContext taskContext,
      ...
      long pageSizeBytes,
      int numElementsForSpillThreshold,
      @Nullable UnsafeInMemoryRadixSorter existingInMemorySorter,
      boolean canUseRadixSort) {
    ...
    this.prefixComparators = prefixComparators;
    ...
    if (existingInMemorySorter == null) {
      ...
      this.inMemSorter = new UnsafeInMemoryRadixSorter(
        this,
        taskMemoryManager,
        comparator,
        prefixComparators,
  ...
  public long getSortTimeNanos() {
    UnsafeInMemoryRadixSorter sorter = inMemSorter;
    if (sorter != null) {
  ...
  public void insertRecord(
      Object recordBase, long recordOffset, int length,
      long prefix1, boolean prefix1IsNull,
      long prefix2, boolean prefix2IsNull)
    throws IOException {
    ...
    pageCursor += length;
    inMemSorter.insertRecord(recordAddress, prefix1, prefix1IsNull,prefix2,prefix2IsNull);
  }
  ...
  /**
   * Merges another UnsafeExternalRadixSorters into this one, the other one will be emptied.
   */
  public void merge(UnsafeExternalRadixSorter other) throws IOException {
    other.spill();
  ...
  public UnsafeSorterIterator getSortedIterator() throws IOException {
    ...
    if (spillWriters.isEmpty()) {
      ...
      final UnsafeRadixSorterSpillMerger spillMerger = new UnsafeRadixSorterSpillMerger(
        recordComparatorSupplier.get(), prefixComparators, spillWriters.size());
  ...
  class SpillableIterator extends UnsafeSorterIterator {
    ...
    public long spill() throws IOException {
      synchronized (this) {
        ...
        long released = 0L;
        synchronized (UnsafeExternalRadixSorter.this) {
