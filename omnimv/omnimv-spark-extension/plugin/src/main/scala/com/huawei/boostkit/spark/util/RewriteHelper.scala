...
object RewriteHelper extends PredicateHelper with RewriteLogger {
  ...
  def enableCachePlugin(): Unit = {
    SQLConf.get.setConfString("spark.sql.omnimv.enable", "true")
    SQLConf.get.setConfString("spark.sql.omnimv.log.enable", "true")
  }

  def disableCachePlugin(): Unit = {
    SQLConf.get.setConfString("spark.sql.omnimv.enable", "false")
    SQLConf.get.setConfString("spark.sql.omnimv.log.enable", "false")
  }
