...
/**
 * The type Int array omni block.
 *
 * @since 20210630
 */
public class IntArrayOmniBlock
        implements Block<Integer>
{
     ...
     * @param values the values
     */
    public IntArrayOmniBlock(int positionCount, IntVec values)
    {
     ...
     * @param values the values
     */
    public IntArrayOmniBlock(VecAllocator vecAllocator, int arrayOffset, int positionCount, byte[] valueIsNull, int[] values)
    {
    ...
    public Block copyPositions(int[] positions, int offset, int length)
    {
        ...
        IntVec newValues = values.copyPositions(positions, offset, length);
        if (valueIsNull != null) {
            newValueIsNull = newValues.getRawValueNulls();
        }
        return new IntArrayOmniBlock(0, length, newValueIsNull, newValues);
    }
    ...
    public Block getRegion(int positionOffset, int length)
    {
        ...
        return new IntArrayOmniBlock(newValues.getOffset(), length, valueIsNull, newValues);
    }
