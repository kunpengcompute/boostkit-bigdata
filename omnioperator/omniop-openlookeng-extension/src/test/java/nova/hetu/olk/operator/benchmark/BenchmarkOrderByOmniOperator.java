...
public class BenchmarkOrderByOmniOperator
{
            ...
            extends AbstractOmniOperatorBenchmarkContext
    {
        ...
        protected OperatorFactory createOperatorFactory()
        {
            ...
            return createOrderByOmniOperatorFactory(0,
                    new PlanNodeId("test"), totalChannels, outputChannels, sortChannels, sortOrders);
        }
    }
    ...
    public static void main(String[] args) throws RunnerException
    {
        Options options = new OptionsBuilder().verbosity(VerboseMode.NORMAL)
                .include(".*" + BenchmarkOrderByOmniOperator.class.getSimpleName() + ".*").build();
