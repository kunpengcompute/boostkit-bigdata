...
public class BenchmarkDistinctLimitOmniOperator
{
    ...
    private static final Map<String, ImmutableList<Type>> INPUT_TYPES = ImmutableMap
            ...
            .put("group1", ImmutableList.of(INTEGER))
            .put("group2", ImmutableList.of(createVarcharType(16)))
            .put("group3", ImmutableList.of(DOUBLE))
            ...
            extends AbstractOmniOperatorBenchmarkContext
    {
        ...
        protected OperatorFactory createOperatorFactory()
        {
            ...
            return new DistinctLimitOmniOperator.DistinctLimitOmniOperatorFactory(0, new PlanNodeId("test"),
                    inputTypes, distinctChannels, Optional.empty(), Integer.parseInt(limit));
        }
    }
