...
import nova.hetu.olk.operator.localexchange.LocalExchangeSinkOmniOperator.LocalExchangeSinkOmniOperatorFactory;
...
public class LocalExchangeSinkOmniOperatorTest
        extends AbstractOperatorTest
{
    ...
    {
        LocalExchangeSinkOmniOperatorFactory localExchangeSinkOmniOperatorFactory = new LocalExchangeSinkOmniOperatorFactory(localExchangeFactory, operatorId, planNodeId, sinkFactoryId,
