...
public class BenchmarkTopNOmniOperator
{
            ...
            extends AbstractOmniOperatorBenchmarkContext
    {
        ...
        protected OperatorFactory createOperatorFactory()
        {
            ...
            //Ungrouped
            return new TopNOmniOperator.TopNOmniOperatorFactory(0, new PlanNodeId("test"), inputTypes,
                    Integer.parseInt(topN), sortChannels, sortOrders);
        }
    }
    ...
    public static void main(String[] args) throws RunnerException
    {
        ...
        data.setup();
        new BenchmarkTopNOmniOperator().topN(data);

        Options options = new OptionsBuilder().verbosity(VerboseMode.NORMAL)
                .include(".*" + BenchmarkTopNOmniOperator.class.getSimpleName() + ".*").build();
