...
public class BenchmarkEnforceSingleRowOmniOperator
{
    private BenchmarkEnforceSingleRowOmniOperator()
    {
    }
    ...
    public static class BenchmarkContext
    {
        ...
        @Benchmark
        public void testEnforceSingleRowOmniOperator(Blackhole blackhole)
        {
            DriverContext driverContext = taskContext.addPipelineContext(0, true, true, false).addDriverContext();
            OperatorFactory factory = new EnforceSingleRowOmniOperator.EnforceSingleRowOmniOperatorFactory(0,
                    new PlanNodeId("plan-node-0"), INPUT_TYPES.get(testGroup));
            ...
            operator.finish();
            BlockUtils.freePage(input.get(0));
            BlockUtils.freePage(input.get(1));
    ...
    {
        List<Page> pages = rowPagesBuilder(INPUT_TYPES.get(testGroup)).addSequencePage(1, 1)
    ...
    public static void main(String[] args) throws RunnerException
    {
        Options options = new OptionsBuilder().verbosity(VerboseMode.NORMAL)
                .include("nova.hetu.olk.operator.benchmark." + BenchmarkEnforceSingleRowOmniOperator.class.getSimpleName() + ".*").build();
