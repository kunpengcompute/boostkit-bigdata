...
public class BenchmarkOmniFilterAndProject
{
    ...
    private static PageProcessor getCompiledProcessor()
    {
        ...
        return new OmniExpressionCompiler(METADATA, new PageFunctionCompiler(METADATA, 10_000))
                .compilePageProcessor(Optional.of(FILTER_FOR_Q1_OMNI_FILTER), ImmutableList.of(PROJECT),
                Optional.empty(), OptionalInt.empty(), inputTypes, new TaskId("test"))
                .get();
    }
    ...
    public static void main(String[] args) throws RunnerException
    {
        Options options = new OptionsBuilder().verbosity(VerboseMode.NORMAL)
                .include(".*" + BenchmarkOmniFilterAndProject.class.getSimpleName() + ".*").build();
