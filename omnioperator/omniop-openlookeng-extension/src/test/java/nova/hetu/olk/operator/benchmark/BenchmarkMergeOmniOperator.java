...
public class BenchmarkMergeOmniOperator
{
    ...
    private static final Map<String, ImmutableList<Type>> INPUT_TYPES = ImmutableMap
            .<String, ImmutableList<Type>>builder().put("group1", ImmutableList.of(INTEGER, INTEGER))
    ...
    public static class BenchmarkContext
    {
        ...
        private MergeOmniOperatorFactory operatorFactory;
        ...
        protected MergeOmniOperatorFactory createOperatorFactory()
        {
            List<Type> totalChannels = INPUT_TYPES.get(testGroup);
            return new MergeOmniOperatorFactory(operatorId.getAndIncrement(),
                    operatorId.getAndIncrement(), new PlanNodeId("test"), exchangeClientFactory,
                    new TestingPagesSerdeFactory(), new OrderingCompiler(), totalChannels, ImmutableList.of(0),
    ...
    public List<Page> merge(BenchmarkContext context)
    {
        DriverContext driverContext = context.testingTaskContext.addPipelineContext(0, true, true, false)
                .addDriverContext();
        MergeOmniOperator operator = (MergeOmniOperator) context.operatorFactory.createOperator(driverContext);
    ...
    public static void main(String[] args) throws RunnerException
    {
        Options options = new OptionsBuilder().verbosity(VerboseMode.NORMAL)
                .include(".*" + BenchmarkMergeOmniOperator.class.getSimpleName() + ".*").build();
