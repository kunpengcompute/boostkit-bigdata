...
package org.apache.spark.sql.execution.adaptive.ock.reader
 ...
 */
case class BoostTuningColumnarCustomShuffleReaderExec(
      child: SparkPlan,
  ...
  override def nodeName: String = "BoostTuningOmniColumnarCustomShuffleReaderExec"
      ...
      cachedShuffleRDD = child match {
        case stage: ShuffleQueryStageExec =>
          new ShuffledColumnarRDD(
            stage.shuffle
              .asInstanceOf[BoostTuningColumnarShuffleExchangeExec]
              .boostTuningColumnarShuffleDependency,
            stage.shuffle.asInstanceOf[BoostTuningColumnarShuffleExchangeExec].readMetrics,
