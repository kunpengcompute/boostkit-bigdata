...
import org.apache.spark.sql.catalyst.plans.{FullOuter, Inner, InnerLike, JoinType, LeftAnti, LeftExistence, LeftOuter, LeftSemi}
...
case class ColumnarShuffledHashJoinExec(
  ...
  override def doExecuteColumnar(): RDD[ColumnarBatch] = {
    ...
    val buildOutputCols: Array[Int] = joinType match {
      case _: InnerLike | FullOuter | LeftOuter =>
