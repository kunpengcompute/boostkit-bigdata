...
class ColumnShuffleSerializerLz4Suite extends SparkFunSuite with SharedSparkSession {
  ...
  test("columnar shuffle deserialize no null lz4 compressed") {
    val input = getTestResourcePath("test-data/shuffle_spilled_mix_100batch_4096rows_lz4")
    val serializer =
